...
public class TalkEventController_3 : MonoBehaviour
{
    // 会話オブジェクト
    [SerializeField] GameObject FirstTalk1;
    [SerializeField] GameObject FirstTalk2;
    [SerializeField] GameObject FirstTalk3;
    [SerializeField] TimeLineControll_3 timeLineControll_3;     // タイムラインコントローラーのメソッドを呼び出すため
    ...
    public void TalkManager()
    {
        ...
        {
            Objectactivefalse();
            timeLineControll_3.destination();     // 目的地のImageを表示するメソッド
        }
    }
