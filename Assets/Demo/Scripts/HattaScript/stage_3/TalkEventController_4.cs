...
public class TalkEventController_4 : MonoBehaviour
{
    // 会話オブジェクト
    [SerializeField] GameObject FirstTalk1;
    [SerializeField] GameObject FirstTalk2;
    [SerializeField] GameObject FirstTalk3;
    [SerializeField] TimeLineControll_4 timeLineControll_4;     // タイムラインコントローラーのメソッドを呼び出すため
    ...
    public void TalkManager()
    {
        ...
        {
            Objectactivefalse();
            timeLineControll_4.destination();     // 目的地のImageを表示するメソッド
        }
    }
