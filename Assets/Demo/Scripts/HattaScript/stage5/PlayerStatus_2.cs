...
public class PlayerStatus_2 : MonoBehaviour
{
    public static PlayerStatus_2 Instance = null;
    ...
    private Player_2 player_2;     // プレイヤーの参照
    ...
    void UpdateStats()
    {
        ...
        float distance = Vector3.Distance(player_2.transform.position, lastPos); // 移動距離の計算
        ...
        lastPos = player_2.transform.position;  // 最後の位置を更新
    ...
    void ReduceHydration(float distance, bool isRunning)
    {
        ...
        else
        {
            ...
            player_2.walkSpeed = player_2.baseWalkSpeed * speedFactor;
            player_2.runSpeed = player_2.baseRunSpeed * speedFactor;
        }
    }
