...
public class TalkEventController_2 : MonoBehaviour
{
    // 会話オブジェクト
    [SerializeField] GameObject FirstTalk1;
    [SerializeField] GameObject FirstTalk2;
    [SerializeField] GameObject FirstTalk3;
    [SerializeField] TimeLineControll_2 timeLineControll_2;     // タイムラインコントローラーのメソッドを呼び出すため
    ...
    public void TalkManager()
    {
        ...
        {
            Objectactivefalse();
            timeLineControll_2.destination();     // 目的地のImageを表示するメソッド
        }
    }
